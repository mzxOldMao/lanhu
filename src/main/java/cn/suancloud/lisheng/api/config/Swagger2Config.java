...
//    }
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("cn.suancloud.lisheng.api"))
    ...
    private List<ApiKey> securitySchemes() {
        return new ArrayList(Arrays.asList(new ApiKey("apiAuthorization", "apiAuthorization", "header"))
                );
    }
    ...
    List<SecurityReference> defaultAuth() {
        ...
        return new ArrayList(Arrays.asList(new SecurityReference("apiAuthorization", authorizationScopes))
                );
    }
